...
namespace AppServer.Api.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<CustomerDTO>>> ListByStatusIdAync(int statusid)
        {
            try
            {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<CustomerDTO>> LoginAsync([FromBody] LoginDTO model)
        {
            try
            {
                ...
                var account = await _mediator.Send(new AuthenticateCustomerCommand { CustomerId = accountId });
